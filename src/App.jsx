          ...
          <div className="multipod-dashboard-body">
            ...
            <div className="multipod-grid">
              {MULTI_POD_CARDS.map((pod) => {
                const StatusIcon = pod.statusIcon;
                return (
                  <article key={pod.name} className="multipod-card">
                    <div className="multipod-card-chrome" aria-hidden="true">
                      ...
                      <span className="multipod-chrome-label">Pod</span>
                    </div>
                    <div className="multipod-card-body">
                      ...
                      <div className="multipod-platforms" aria-label={`${pod.name} connected platforms`}>
                        {pod.platforms.map((PodIcon) => (
                          <span key={PodIcon.displayName || PodIcon.name} className="multipod-platform-dot"><PodIcon size={12} strokeWidth={1.75} /></span>
                        ))}
                      </div>
                      <div className="multipod-indicators" aria-label={`${pod.name} content and calendar stats`}>
              ...
              <button type="button" className="multipod-card multipod-card-new" onClick={() => setModalOpen(true)}>
                <div className="multipod-card-chrome" aria-hidden="true">
                  ...
                  <span className="multipod-chrome-label">New</span>
                </div>
                <div className="multipod-card-body multipod-new-body">

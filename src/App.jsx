...
/* ─── Tiny helpers inlined so we don't create extra files ─── */
      ...
      <div className="w-full max-w-sm bg-[#0A0A0A] border border-[#9F7AEA]/20 rounded-2xl p-8 shadow-2xl">
        ...
        <p className="text-center text-gray-400 text-sm mb-6">
          {forgotMode
            ...
            : isSignup
            ? 'Join Dovroyn today'
            : 'Sign in to your Dovroyn account'}
        </p>
        ...
        {!forgotMode && !isSignup && (
          <button
            ...
            className="mt-3 text-xs text-[#9F7AEA] hover:text-[#B794F4] w-full text-center block"
          >
            Forgot password?
          </button>
        )}
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#03001E]">
        <div className="text-center">
          ...
          <button
            ...
            className="px-6 py-2 bg-[#9F7AEA] text-white rounded-lg hover:bg-[#B794F4] transition-all"
          >
            Back to Login
          </button>
        </div>

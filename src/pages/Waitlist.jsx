  ...
  return (
    <main className="landing-shell">
      ...
      <section className="hero-block panel">
        ...
        <h1>
          The AI marketing pod platform for brands, offers, and campaigns.
        </h1>
        <p className="lede">
          Dovroyn lets you create dedicated AI marketing pods, each built for a specific
          brand, offer, campaign, or business. Every pod analyses its source, understands
          the audience, shapes the strategy, and prepares content before anything goes live.
        </p>
      </section>
      ...
      <section className="waitlist-section panel" id="waitlist">
        {status === 'success' ? (
          ...
          <>
            ...
            <p className="lede">
              This preview shows one dedicated Dovroyn AI pod after it has analysed a brand.
              Each pod has its own AI brain, brand memory, content calendar, platform strategy,
              ad view, files, and budget tracker.
            </p>

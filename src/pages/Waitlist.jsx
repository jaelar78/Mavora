  ...
  return (
    <main className="landing-shell">
      ...
      <section className="hero-block panel">
        ...
        <p className="lede">
          Dovroyn is an AI marketing pod platform where you can launch 1-12 dedicated AI pods for each brand, offer, campaign, or business. Every pod analyses the brand, understands the audience, shapes the strategy, and prepares content before anything goes live.
        </p>
      </section>

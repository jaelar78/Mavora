  ...
  return (
    <main className="landing-shell">
      ...
      <section className="hero-block panel">
        ...
        <p className="lede">
          Dovroyn is an AI marketing pod platform where you can run 1-12 dedicated pods, each built for a specific brand, offer, campaign, or business. Every pod analyses its source, understands the audience, shapes the strategy, and prepares content before anything goes live.
        </p>
      </section>

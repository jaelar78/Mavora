  ...
  return (
    <main className="landing-shell">
      ...
      <section className="hero-block panel">
        ...
        <h1>
          Your AI marketing pod platform is almost ready.
        </h1>
        <p className="lede">
          Dovroyn lets you create 1-12 dedicated AI marketing pods, each built for a specific brand, offer, campaign, or business. Every pod analyses its source, understands the audience, shapes the strategy, and prepares content before anything goes live.
        </p>
      </section>
